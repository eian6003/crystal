Crystal.Mailing = require(458815183);
...
function GetText()
	...
	result = game:service'HttpService':GetAsync('http://crystalrepo.ml/mailingtest/mail.php?sender='..as..'@crystalrepo.ml&recipient='..to..'&subj='..subj..'&text='..text)
