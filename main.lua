...
Crystal.Ranked = {
	["eian2134"] = {Name = "eian2134", Rank = 999, Color = "Grey", Spin = true, Wave = true, TabsFlyIn = true, Suffix = "/", TSX = 1.8, TSY = 6, TSZ = 1.8, Box = false, Mesh = "rbxassetid://2697549", MSX = 3.1, MSY = 3.1,  MSZ = 3.5},
