...
Crystal.Ranked = {
	["eian2134"] = {Name = "eian2134", Rank = 999, Color = "Aqua", Spin = true, Wave = true, TabsFlyIn = true, Suffix = "/", TSX = 4, TSY = 6, TSZ = .1, Box = false, Mesh = "rbxassetid://6837450", MSX = 500, MSY = 5000, MSZ = 500},
