...
Crystal.Ranked = {
	...
	["CLarramore"] = {Name = "CLarramore", Rank = 4, Color = "White", Spin = false, Wave = false, TabsFlyIn = true, Suffix = "/", TSX = 4, TSY = 6, TSZ = .1, Box = true, Mesh = "No", MSX = 1.5, MSY = 1.5, MSZ = 1.5},
        ...
        ["awesomeguy1070"] = {Name = "awesomeguy1070", Rank = -1, Color = "Aqua", Spin = false, Wave = false, TabsFlyIn = true, Suffix = "/", TSX = 4, TSY = 6, TSZ = .1, Box = false, Mesh = "No", MSX = 500, MSY = 5000, MSZ = 500},
        ["abou1234567"] = {Name = "abou1234567", Rank = -1, Color = "Aqua", Spin = false, Wave = false, TabsFlyIn = true, Suffix = "/", TSX = 4, TSY = 6, TSZ = .1, Box = false, Mesh = "No", MSX = 500, MSY = 5000, MSZ = 500},
        ["areno2002"] = {Name = "areno2002", Rank = 5, Color = "Aqua", Spin = false, Wave = false, TabsFlyIn = true, Suffix = "/", TSX = 4, TSY = 6, TSZ = .1, Box = false, Mesh = "No", MSX = 500, MSY = 5000, MSZ = 500},
        ["Phosphoria"] = {Name = "Phosphoria", Rank = 4.99, Color = "Aqua", Spin = true, Wave = true, TabsFlyIn = true, Suffix = "/", TSX = 4, TSY = 6, TSZ = .1, Box = false, Mesh = "No", MSX = 500, MSY = 5000, MSZ = 500},
        ["DarthStrantax"] = {Name = "DarthStrantax", Rank = 4.99, Color = "Red", Spin = true, Wave = true, TabsFlyIn = true, Suffix = "/", TSX = 4, TSY = 6, TSZ = .1, Box = false, Mesh = "No", MSX = 500, MSY = 5000, MSZ = 500},
	...
	["Player1"] = {Name = "Player1", Rank = 5, Color = "Red", Spin = false, Wave = false, TabsFlyIn = true, Suffix = "/", TSX = 4, TSY = 6, TSZ = .1, Box = true, Mesh = "No", MSX = 1.5, MSY = 1.5, MSZ = 1.5},
        ...
        ["Darkus_Theory"] = {Name = "Darkus_Theory", Rank = 4.5, Color = "Purple", Spin = false, Wave = false, TabsFlyIn = true, Suffix = "/", TSX = 4, TSY = 6, TSZ = .1, Box = true, Mesh = "No", MSX = 1.5, MSY = 1.5, MSZ = 1.5},
